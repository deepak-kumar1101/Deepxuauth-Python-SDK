...
class DXA:
    PINNED_CERT_SHA256 = "FF:59:5C:CE:F6:00:20:4D:B3:3D:94:5E:AA:14:DC:A6:53:1C:81:F4:70:DC:E6:35:20:67:91:F2:57:4F:19:99"
    ...
    def __init__(
        ...
        secret: str,
        version: str,
        api_url: str = "https://deepxauth.pages.dev"
    ):
    ...
    def init(self):
        if not self.app_name or not self.secret or not self.version:
            self.response_message = "AppName/Secret/Version missing"
            return False
        ...
        try:
            ...
            self.is_version_correct, self.server_version = self._check_version_with_details()
            ...
            self.response_message = "Initialization successful"
    ...
    def login(self, username: str, password: str) -> LoginResult:
        ...
        if not self.is_initialized:
            self.response_message = "Error: Call DXA.Init() first"
    ...
    def _verify_response_certificate(self, response: requests.Response) -> True:
